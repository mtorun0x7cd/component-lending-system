...
<HTML lang="DE">
	...
	<BODY>
		...
		<DIV class="container">
			<DIV class="center">
				<H1>
					In diesem Abschnitt möchten wir Ihnen das Labor und die Mitarbeiter vorstellen
				</H1>
				<H2>
					Das Labor:
				</H2>
				
				<IMG src="bilder/labor/1.jpg" style="width:94%;">
				...
				<DIV class="clearfix" style="margin-top: 50px">
					<UL>
						<IMG src="bilder/labor/mitarb_1.jpg" class="float-left" style="width: 15%">
						<P>
							Name: Max Mustermann
						</P>
						<P>
							E-Mail: 
							<A href="mailto:max.mustermann@th-koeln.de">
								max.mustermann@th-koeln.de
							</A>
						</P>
					</UL>                
				</DIV>
