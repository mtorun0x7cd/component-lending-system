	...
	<BODY>
		...
		<DIV class="container">
			<DIV class="center">
				...
				<H3>
					Geben Sie Ihre Stu - Mail sowie zwei mal das gleich Passwort ein. 
					Bei erfolgreicher Übermittlung können Sie, wie gewohnt die Web Seite verwenden.
				</H3>
				...
				<FORM action="<?PHP echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
					...
					<DIV class="form-group">
						...
						<INPUT type="password" class="form-control" name="passwordOne" placeholder="****">
					</DIV>
					<DIV class="form-group">
						<LABEL>
							Passwort wiederholen
						</LABEL>
						<INPUT type="password" class="form-control" name="passwordTwo" placeholder="****">
					</DIV>
					<BUTTON class="btn btn-outline-success my-2 my-sm-0" type="submit">
						Zuruecksetzen
					</DIV>
