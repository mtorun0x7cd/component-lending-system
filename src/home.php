...
<HTML lang="DE">
	...
	<BODY>
		...
		<DIV class="container">
			<DIV class="center">
				<H1>
					Willkommen zur Bauteilverwaltung
				</H1>
				<H4>
					Auf dieser Webseite können Sie sich Bauteile zur Ausleihe vormerken lassen.
				</H4>
				<H4>
					Dazu suchen Sie ihre benötigten Bauteile im Inventar, verschieben diese in den Warenkorb und checken aus. 
					Anschließen erhalten Sie per mail eine Ausleihbestätigung. 
					Diese bringen Sie zur Abholung, unterschrieben mit.
				</H4>
				<H4>
					Eure Bauteilverwaltung
				</H4>
			</DIV>
		</DIV>
		<!-- /Home: Willkommenstext -->
