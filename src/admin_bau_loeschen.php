<?PHP
	...
	{		
		...
		{		
			...
			$query = "DELETE FROM artikel WHERE teilenummer = $teilenummerSel";
			
			if ($result = mysqli_query($connection, $query))
			{
				$err = 
				"
				Der Artikel mit der Teilenummer $teilenummerSel wurde gelöscht!
				";
			}
			else 
			{
		...
		{
			$err = "ERROR: Das Bauteil muss vorher ausgewählt werden!";
		}
							...
							if ($_SESSION["id"] > 2)
							{
								...
								<LI class='nav-item dropdown'>
									...
									<DIV class='dropdown-menu' aria-labelledby='navbarDropdown'>
										...
										<A class='dropdown-item active' href='admin_bau_loeschen.php'>
											Bauteil/e löschen
