	...
	<BODY>
		...
		<DIV class="container">
			<DIV class="center">
				...
				<H3>
					Bitte geben Sie ihre Informationen in das Formular ein und bestätigen 
					diese durch den Senden Button. Anschließend erhalten Sie eine Bestätigungsmail. 
					Folgen Sie bitte den, in der Mail geschildertem Anweisungen.
				</H3>
				...
				<FORM action="<?PHP echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
					<DIV class="form-group">
						...
						<INPUT type="email" class="form-control" id="email" placeholder="max.mustermann@smail.th-koeln.de">
					</DIV>
					<DIV class="form-group">
						<LABEL>
							Name
